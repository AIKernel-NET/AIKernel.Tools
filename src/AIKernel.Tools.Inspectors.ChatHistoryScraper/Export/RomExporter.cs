...
/// <summary>[EN] Documents this public package API member. [JA] RomExporter を表します。</summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] ToRom を実行します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ToRom を取得します。</summary>
